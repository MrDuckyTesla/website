!(function() {
 ...
 // tslint:disable-line:max-line-length
  ...
  const deactivateActiveAudioNodeInputConnections = (audioNode, trace) => {
    ...
    // Bug #149: Safari does not yet support the detune AudioParam.
    audioNode.playbackRate ] : isAudioWorkletNode(audioNode) ? Array.from(audioNode.parameters.values()) : (audioNode => "frequency" in audioNode && "gain" in audioNode)(audioNode) ? [ audioNode.Q, audioNode.detune, audioNode.frequency, audioNode.gain ] : (audioNode => "offset" in audioNode)(audioNode) ? [ audioNode.offset ] : (audioNode => !("frequency" in audioNode) && "gain" in audioNode)(audioNode) ? [ audioNode.gain ] : (audioNode => "detune" in audioNode && "frequency" in audioNode)(audioNode) ? [ audioNode.detune, audioNode.frequency ] : (audioNode => "pan" in audioNode)(audioNode) ? [ audioNode.pan ] : [];
 ...
 // tslint:disable-line:no-empty
  ...
  class p5soundNode {
    ...
    /**
       ...
       * </div>
       */    amp(value, p = .1) {
      if ("object" == typeof value) return void value.connect(this.output.gain);
    ...
    /**
       ...
       */    setInput(source) {
      //for p5 nodes
      "function" != typeof source.getNode && ("function" != typeof source.connect || void 0 === source.output) ? 
      //for web audio nodes
      source instanceof AudioNode && source.connect(this.input) : source.connect(this.input);
      //for tone.js nodes
        }
    /**
  ...
  class Gain$2 extends ToneAudioNode {
    constructor() {
      const options = optionsFromArguments(Gain$2.getDefaults(), arguments, [ "gain", "units" ]);
  ...
  class Volume extends ToneAudioNode {
    constructor() {
      ...
      super(options), this.name = "Volume", this.input = this.output = new Gain$2({
        context: this.context,
        gain: options.volume,
        units: "decibels"
  ...
  /**
    ...
    /**
      ...
      if ("custom" === this._type) {
        return Oscillator$2._periodicWaveCache.find((description => {
      ...
      {
        const oscProps = Oscillator$2._periodicWaveCache.find((description => description.type === this._type && description.phase === this._phase));
      ...
      this._oscillator.type = type); else {
        ...
        if (isDefined(cache)) {
          ...
          Oscillator$2._periodicWaveCache.push({
            ...
            type: this._type,
            wave: this._wave
          }), Oscillator$2._periodicWaveCache.length > 100 && Oscillator$2._periodicWaveCache.shift();
        }
      }
    }
    get baseType() {
  ...
  class Oscillator extends p5soundSource {
    constructor(frequency = 440, type = "sine") {
      let tempType;
      let tempFrequency;
      super(), [ "sine", "triangle", "sawtooth", "square" ].includes(frequency) && (tempType = frequency, 
      tempFrequency = [ "sine", "triangle", "sawtooth", "square" ].includes(type) ? 440 : type, 
      type = tempType, frequency = tempFrequency), this.frequency = frequency, this.type = type, 
      this.node = (new Oscillator$2).connect(this.output), this.node.frequency.value = this.frequency, 
      this.node.type = this.type, this.node.volume.value = -6;
    }
    /**
       ...
       * </div>
       */    freq(f, rampTime = 0) {
      if ("number" == typeof f) this.node.frequency.rampTo(clamp(f, 0, 24e3), rampTime); else {
        if ("string" != typeof f) return void console.warn("Oscillator.freq(): argument must be a number (Hz) or a note name string (e.g. 'C4')");
        {
          let hz = clamp((value = f, new FrequencyClass(getContext(), value, units)).toFrequency(), 0, 24e3);
  ...
  __decorate([ timeRange(0) ], Envelope$2.prototype, "attack", void 0), __decorate([ timeRange(0) ], Envelope$2.prototype, "decay", void 0), 
  __decorate([ (function(min, max = 1 / 0) {
    const valueMap = new WeakMap;
    return function(target, propertyKey) {
      Reflect.defineProperty(target, propertyKey, {
        configurable: !0,
  ...
  })(0, 1) ], Envelope$2.prototype, "sustain", void 0), __decorate([ timeRange(0) ], Envelope$2.prototype, "release", void 0);
  /**
  ...
  /**
    ...
    constructor() {
      ...
      this.name = "AmplitudeEnvelope", this._gainNode = new Gain$2({
        context: this.context,
        gain: 0
  ...
  /**
    ...
    constructor() {
      const options = optionsFromArguments(Delay$2.getDefaults(), arguments, [ "delayTime", "maxDelay" ]);
  ...
  /**
    ...
    constructor(options) {
      ...
      /**
             ...
             */
      this.effectSend = new Gain$2({
        context: this.context
      }), 
      /**
             * connect the output of the effect to the effectReturn
             */
      this.effectReturn = new Gain$2({
        context: this.context
      }), 
      /**
             * The effect input node
             */
      this.input = new Gain$2({
        context: this.context
      }), 
      /**
             * The effect output
  ...
  /**
    ...
    constructor() {
      ...
      super(options), this.name = "FeedbackDelay", this._delayNode = new Delay$2({
        context: this.context,
  ...
  /**
    ...
    constructor() {
      const options = optionsFromArguments(Noise$2.getDefaults(), arguments, [ "type" ]);
  ...
  /**
    ...
    /**
      ...
      return __awaiter(this, void 0, void 0, (function*() {
        ...
        const noiseL = new Noise$2({
          context: context
        });
        const noiseR = new Noise$2({
          context: context
        });
  ...
  /**
    ...
    constructor() {
      ...
      /**
             * Indicates if the value should be overridden on connection
             */
      this.override = !1, this._mult = this.input = this.output = new Gain$2({
        context: this.context,
        minValue: options.minValue,
        maxValue: options.maxValue
  ...
  /**
    ...
    constructor() {
      ...
      // @ts-ignore
      this._clampValue = Param.prototype._clampValue, this._oscillator = new Oscillator$2(options), 
      this.frequency = this._oscillator.frequency, this._amplitudeGain = new Gain$2({
        context: this.context,
  ...
  /**
    ...
    constructor() {
      ...
      super(options), this.name = "PitchShift", this._frequency = new Signal({
        ...
        max: .1,
        type: "sawtooth"
      }).connect(this._delayA.delayTime), this._delayB = new Delay$2({
        maxDelay: 1,
        context: this.context
      }), this._lfoB = new LFO({
        context: this.context,
        ...
        type: "triangle",
        phase: 90
      }).connect(this._crossFade.fade), this._feedbackDelay = new Delay$2({
        delayTime: options.delayTime,
        context: this.context
  ...
  /**
    ...
    constructor() {
      ...
      /**
             ...
             */
      this._buffers = [], this.input = this.output = this._gain = new Gain$2({
        context: this.context
  ...
  /**
    ...
    constructor() {
      const options = optionsFromArguments(FFT$2.getDefaults(), arguments, [ "size" ]);
  ...
  /**
    ...
    constructor() {
      const options = optionsFromArguments(Panner$2.getDefaults(), arguments, [ "pan" ]);
  ...
  /**
    ...
    constructor(amount = 0) {
      super(), this.node = new Panner$2(amount);
      const toneInput = this.node.input.input ?? this.node.input;
      const toneOutput = this.node.output.output ?? this.node.output;
      this.input.connect(toneInput), toneOutput.connect(this.output);
    }
    /**
         ...
         * </div>
         */    pan(amount) {
      "object" != typeof amount ? this.node.pan.rampTo(clamp(amount, -1, 1), .01) : amount.output.connect(this.node.pan.input);
    }
  };
  /**
  ...
  p5.SoundFile = SoundFile$1, p5.prototype.loadSound = 
  /**
  ...
  /**
     ...
     */
  function(path) {
    if ("string" == typeof path && (path = encodeURI(path)), self._incrementPreload && self._decrementPreload) {
      return self._incrementPreload(), new p5.SoundFile(path, (function() {
